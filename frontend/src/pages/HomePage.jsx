...
function HomePage() {
  ...
  return (
    <div className="min-h-screen">
       ...
       * HERO SECTION
       * ===================================================================== */}
      <section className="relative bg-gradient-to-br from-primary-800 via-primary-700 to-accent-600 text-white overflow-hidden">
        {/* Background Pattern */}
       ...
       * FINAL CTA SECTION
       * ===================================================================== */}
      <section className="py-20 bg-gradient-to-r from-primary-700 to-accent-600">
